...
<?php
          ...
          {
          echo "<img class='card-img-top img-thumbnail' src='../admin/images/blog/$view_post_image'><br><br>";  
          }
           if($view_post_image1=="")
          {
          ...
          {
          echo "<img class='card-img-top img-thumbnail' src='../admin/images/blog/$view_post_image1'><br><br>";  
          }
            if($view_post_image2=="")
          {
          ...
          {
          echo "<img class='card-img-top img-thumbnail' src='../admin/images/blog/$view_post_image2'><br><br>";  
          }
            if($view_post_image3=="")
          {
