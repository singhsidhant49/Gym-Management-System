    ...
    <div class="row">
      ...
      <div class="col-md-8">
        ...
        if (isset($_GET['catid'])) 
        {
          ...
          $result_sql_select_category_page = mysqli_query($conn, $sql_select_category_page);
        ...
        <?php 
                $sql_select_post = "SELECT * FROM posts WHERE  post_category = {$selected_category_page} ORDER BY id desc LIMIT {$start} ,{$no_posts_per_page}";
        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            ...
            <a href="post.php?postid=<?php echo $view_post_id;?>" class="btn btn-primary">Read More &rarr;</a>
          </div>
          <?php 
          ...
          <div class="card-footer text-muted">
            <img src="../admin/images/users/<?php echo $view_users_image; ?>" class="zoom3 mr-2 img-circle" alt="User Image" width="50" align="left" hspace="5">
            By <a href="#"><?php echo $view_users_name; ?></a><br>
