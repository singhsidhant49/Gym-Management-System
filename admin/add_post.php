...
include'../connect.php';
 ...
 $destinationfile='images/blog/'.$filename;
...
$destinationfile1='images/blog/'.$filename1;
...
correctImageOrientation($destinationfile1);
 ...
 $destinationfile2='images/blog/'.$filename2;
...
$filename3= $imd['name'];
 ...
 $destinationfile3='images/blog/'.$filename3;
...
//}
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                      ...
                      <input type="hidden" class="form-control" id="post_autor" name="post_autor" value="<?php echo $_SESSION['id']; ?>">
