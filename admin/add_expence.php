                  ...
                  <div class="col-lg-1"></div>
                    <div class="col-lg-10">
                        ...
                        <!--xxxxxxxxxxxxxxxxxxxx----FORM----xxxxxxxxxxxxxxxxxxxxx -->
                                    <form class="form-horizontal" action="save_expense.php" method="POST" name="enqform">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="customer_name" placeholder="expense Name"  class="form-control"  required>
                                                </div>
                                            </div>
                                        </div>
