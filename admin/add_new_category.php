<?php
      ...
      if (isset($_POST['save_category']))
      {
        ...
        $add_cat_title = mysqli_real_escape_string($conn, $add_cat_title);
        $add_cat_desc = mysqli_real_escape_string($conn, $add_cat_desc);
        $add_cat_slug = mysqli_real_escape_string($conn, $add_cat_slug);
        ...
        $result_sql_add_category= mysqli_query($conn, $sql_add_category);
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="radio" name="cat_status" id="cat_status"  class="ml-3" value="0"> Draft
                </div>
                <div class="form-group col-md-6">
                  <label for="cat_priority" class="col-form-label">Category priority:</label>
                  <input type="text" class="form-control px-2" id="cat_priority" name="cat_priority" placeholder="Enter priority number 0-9" required="">
                </div>
              </div>
              </div>
