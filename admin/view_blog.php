    ...
    <div class="row">
      ...
      <div class="col-md-8">
        ...
        <div class="card mb-4">
          ...
          {
          echo "<img class='card-img-top img-thumbnail' src='images/blog/$view_post_image'><br>";  
          }
           if($view_post_image1=="")
          {
          ...
          {
          echo "<img class='card-img-top img-thumbnail' src='images/blog/$view_post_image1'><br>";  
          }
            if($view_post_image2=="")
          {
          ...
          {
          echo "<img class='card-img-top img-thumbnail' src='images/blog/$view_post_image2'><br>";  
          }
            if($view_post_image3=="")
          {
          ...
          <div class="card-body">
            <h1 class="card-title font-weight-bold"><?php echo $view_post_title; ?></h1>
            <p class="card-text">
