  ...
  <div class="modal fade" id="myModal">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <!-- Modal body -->
        <form name="modalform" action="delete_purchase.php" method="post">
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title"><a href="purchase.php" class="btn btn-primary">Purchase</a></h3>
                  </div>
                  <!-- /.card-header -->
                  <div class="card-body">
                      ...
                      <table id="example1" class="table table-bordered table-striped " cellspacing="0" cellpadding="0">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td> <button type="button" id="<?php echo $row['invoiceno']; ?>" class="btn btn-danger bt mb-1"><i class=" fa fa-trash"  aria-hidden="true"></i></button></td>

                            <input type="hidden" name="smd" value="<?php echo $row['invoiceno']; ?>">
                         

                       <td>   <a href="purchase_detail.php?smd=<?php echo $row['id'];?>"class="text-white btn btn-primary mb-1"><i class=" fas fa-info-circle"  aria-hidden="true"></i></a></td>
 <!-- 
