...
else
{
   ...
   if(!empty($_POST['mmonth']))
{
      $query=" UPDATE members SET plan='".$mplan."',amount='".$rate."',months='".$mon." Months',paid_date='".$cdate."',expiry_date='".$expiredate."',pendingpayment='".$pendingpayment."',pendingdate='".$pendingdate."',status='".$active."' WHERE contact='".$contact."'";

}
else
{

     $query=" UPDATE members SET plan='".$mplan."',amount='".$rate."',months='".$mon." Days',paid_date='".$cdate."',expiry_date='".$expiredate."',pendingpayment='".$pendingpayment."',pendingdate='".$pendingdate."',status='".$active."' WHERE contact='".$contact."'";
