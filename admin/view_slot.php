 ...
 <div class="modal fade" id="myModal">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <!-- Modal body -->
        <form name="modalform" action="delete_slott.php" method="post">
                 ...
                 $no=1;
                    ...
                    <tr>
                      ...
                      <td><?php echo $row['timeslot']; ?></td> 
                        ...
                        <?php
                    //     $count=0;
                    //     $q="select * from timeboook where sid='".$row['id']."'";
                    ...
                    // }
                    ?>
                      <td><?php  echo $row['nummember'] ; ?></td>

                     
                      
                      <td><button type="button" id="<?php echo $row['id']; ?>" class="btn btn-danger bt mb-1"><i class=" fa fa-trash"  aria-hidden="true"></i></button>
                      <button class="btn btn-success"><a href="update_slot.php?id=<?php echo $row['id'];?>"class="text-white"><i class="fa fa-edit"></i></a></button>
                       <button class="btn btn-primary"><a href="view_slot_detail.php?id=<?php echo $row['id'];?>"class="text-white"><i class="fa fa-eye"></i></a></button>
